      ...
      <el-main>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="详细地址" prop="address">
            <el-autocomplete class="inline-input" v-model="ruleForm.address" placeholder="请输入地址"></el-autocomplete>
            当前城市：{{ address }}
          </el-form-item>
          ...
          <el-form-item label="店铺特点">
            品牌保证
            <el-switch v-model="ruleForm.flag" active-color="#20a0ff" inactive-color="#bfcbd9"></el-switch>

            蜂鸟专送
            <el-switch v-model="ruleForm.flag1" active-color="#20a0ff" inactive-color="#bfcbd9"></el-switch>
           
            新开店铺
            <el-switch v-model="ruleForm.flag2" active-color="#20a0ff" inactive-color="#bfcbd9" class="a"></el-switch>
            
            外卖保
            <el-switch v-model="ruleForm.flag3" active-color="#20a0ff" inactive-color="#bfcbd9"></el-switch>
           
            准时达
            <el-switch v-model="ruleForm.flag4" active-color="#20a0ff" inactive-color="#bfcbd9"></el-switch>
           
            开发票
            <el-switch v-model="ruleForm.flag5" active-color="#20a0ff" inactive-color="#bfcbd9"></el-switch>
          </el-form-item>

          <el-form-item label="配送费">
            <el-input-number v-model="ruleForm.num" controls-position="right" @change="handleChange" :min="1" :max="10"></el-input-number>
          </el-form-item>

          <el-form-item label="起送价">
            <el-input-number v-model="ruleForm.num1" controls-position="right" @change="handleChange1" :min="1" :max="10"></el-input-number>
          </el-form-item>
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button size="mini" type="danger" @click="delss(scope.$index)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
          <el-form-item>
